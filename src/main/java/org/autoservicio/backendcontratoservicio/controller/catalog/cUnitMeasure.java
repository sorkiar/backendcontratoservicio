...
import org.autoservicio.backendcontratoservicio.service.catalog.UnitMeasureService;
...
public class cUnitMeasure {
    private final UnitMeasureService service;

    @GetMapping("/listar")
    public Mono<ResponseEntity<genericModel<List<UnitMeasureResponse>>>> listar() {
