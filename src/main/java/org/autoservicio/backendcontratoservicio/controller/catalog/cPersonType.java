...
import org.autoservicio.backendcontratoservicio.service.catalog.PersonTypeService;
...
public class cPersonType {
    ...
    @GetMapping("/listar")
    public Mono<ResponseEntity<genericModel<List<PersonTypeResponse>>>> listar() {
